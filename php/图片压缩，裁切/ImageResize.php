...
class ImageResize {
  ...
  static public function image_scale_cropped($source, $destination, $width, $height)
  {
      $info = ImageResize::image_get_info($source);
   ...
   */
  static public function image_gd_resize($source, $destination, $width, $height, $source_x = 0, $source_y = 0, $source_width = null, $source_height = null) {
