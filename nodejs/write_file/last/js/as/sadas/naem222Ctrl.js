...
let naem222Module = angular.module('naem222Module', [
    'serviceModule',
...
export default function() {
    naem222Module.controller("naem222Ctrl", naem222Ctrl)
    naem222Ctrl.$inject = ['$scope', '$interval', 'uiGridConstants', 'i18nService', '$q', 'pNotify',
        'tableFactory', 'tableModal', '$timeout', 'BASE_URL', 'services', 'urlCode'
    ];

    function naem222Ctrl($scope, $interval, uiGridConstants, i18nService, $q, pNotify, tableFactory, tableModal, $timeout, BASE_URL, services, oauth, urlCode) {
        $scope.searchData = {};
