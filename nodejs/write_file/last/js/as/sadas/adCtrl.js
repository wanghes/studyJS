...
let undefinedModule = angular.module('undefinedModule', [
    'serviceModule',
...
export default function() {
    undefinedModule.controller("undefinedCtrl", undefinedCtrl)
    undefinedCtrl.$inject = ['$scope', '$interval', 'uiGridConstants', 'i18nService', '$q', 'pNotify',
        'tableFactory', 'tableModal', '$timeout', 'BASE_URL', 'services', 'urlCode'
    ];

    function undefinedCtrl($scope, $interval, uiGridConstants, i18nService, $q, pNotify, tableFactory, tableModal, $timeout, BASE_URL, services, oauth, urlCode) {
        $scope.searchData = {};
