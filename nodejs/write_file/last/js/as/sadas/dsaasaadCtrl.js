...
let dsaasaadModule = angular.module('dsaasaadModule', [
    'serviceModule',
...
export default function() {
    dsaasaadModule.controller("dsaasaadCtrl", dsaasaadCtrl)
    dsaasaadCtrl.$inject = ['$scope', '$interval', 'uiGridConstants', 'i18nService', '$q', 'pNotify',
        'tableFactory', 'tableModal', '$timeout', 'BASE_URL', 'services', 'urlCode'
    ];

    function dsaasaadCtrl($scope, $interval, uiGridConstants, i18nService, $q, pNotify, tableFactory, tableModal, $timeout, BASE_URL, services, oauth, urlCode) {
        $scope.searchData = {};
