...
let sdsaModule = angular.module('sdsaModule', [
    'serviceModule',
...
export default function() {
    sdsaModule.controller("sdsaCtrl", sdsaCtrl)
    sdsaCtrl.$inject = ['$scope', '$interval', 'uiGridConstants', 'i18nService', '$q', 'pNotify',
        'tableFactory', 'tableModal', '$timeout', 'BASE_URL', 'services', 'urlCode'
    ];

    function sdsaCtrl($scope, $interval, uiGridConstants, i18nService, $q, pNotify, tableFactory, tableModal, $timeout, BASE_URL, services, oauth, urlCode) {
        $scope.searchData = {};
