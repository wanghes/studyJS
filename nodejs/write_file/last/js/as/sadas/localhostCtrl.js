...
let localhostModule = angular.module('localhostModule', [
    'serviceModule',
...
export default function() {
    localhostModule.controller("localhostCtrl", localhostCtrl)
    localhostCtrl.$inject = ['$scope', '$interval', 'uiGridConstants', 'i18nService', '$q', 'pNotify',
        'tableFactory', 'tableModal', '$timeout', 'BASE_URL', 'services', 'urlCode'
    ];

    function localhostCtrl($scope, $interval, uiGridConstants, i18nService, $q, pNotify, tableFactory, tableModal, $timeout, BASE_URL, services, oauth, urlCode) {
        $scope.searchData = {};
